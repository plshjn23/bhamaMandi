...
public class TransactionActivity extends BaseActionbarActivity {
    ...
    private OfferTabAdapterTransaction offerTabAdapterEnrolled;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mToolbarTitle.setText("Your Transactions");
        ...
        offerTabAdapterEnrolled = new OfferTabAdapterTransaction(this);
    ...
    protected int getActivityLayout() {
        return R.layout.activity_tranaction;
    }
